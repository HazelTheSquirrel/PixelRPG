...
public final class CraftingService{
 ...
 private long craftExperience(CraftRecipe r){long count=r.costs().values().stream().mapToLong(Integer::longValue).sum();return Math.max(20L,r.requiredProfessionLevel()*6L+count*5L);}
