...
public final class Level {
    ...
    public static int fromExperience(long totalExperience) {
        ...
        int low = 0, high = REQUIRED_EXPERIENCE.length - 1;
        while (low <= high) {
    ...
    public static long getExperienceToNextLevel(long totalExperience) {
        long experience = Math.max(0L, totalExperience);
        return Math.max(0L, getExperienceForNextLevel(fromExperience(experience)) - experience);
    }
    ...
    public static long getExperienceForTranscendence() {
        ...
        return Math.addExact(level99, Math.multiplyExact(level99 - level98, 10_000L));
    }
    ...
    private static long[] createExperienceTable() {
        ...
        long[] increments = {
            400L,900L,1400L,2100L,2800L,3600L,4500L,5400L,6500L,7600L,8700L,9800L,11000L,12300L,13600L,15000L,16400L,17800L,19300L,20800L,
            22400L,24000L,25500L,27200L,28900L,30500L,32200L,33900L,36300L,38800L,41600L,44600L,48000L,51400L,55000L,58700L,62400L,66200L,70200L,74300L,
            78500L,82800L,87100L,91600L,96300L,101000L,105800L,110700L,115700L,120900L,126100L,131500L,137000L,142500L,148200L,154000L,159900L,165800L,172000L,
            290000L,317000L,349000L,386000L,428000L,475000L,527000L,585000L,648000L,717000L,1523800L,1539600L,1555700L,1571800L,1587900L,1604200L,1620700L,1637400L,1653900L,1670800L
        };
        long cumulative = 0L;
        experience[0] = 0L;
        for (int level = 1; level <= 79; level++) {
            cumulative = Math.addExact(cumulative, increments[level - 1]);
