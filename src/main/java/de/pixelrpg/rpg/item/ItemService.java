...
public final class ItemService implements ItemAPI {
    ...
    @Override
    public Optional<ItemStack> createUnidentifiedItem(Material material, ItemRarity rarity, int itemRank) {
        return RPGItemBuilder.createUnidentified(material, rarity, itemRank);
    }
